...
%  \author{{\href{https://www.matthewfeickert.com/}{\underline{Matthew Feickert}$^{1}$}}, \href{https://dsi.wisc.edu/staff/cranmer-kyle/}{Kyle Cranmer$^{1}$}}
 ...
 GPU enabled software can be difficult to work with and often requires expertise to deploy.
...
%  %
 ...
 \textbf{Fully reproducible environments with Pixi}
  \begin{center}
   \includegraphics[width=\textwidth]{tools_pixi.pdf}
  \end{center}
 \begin{itemize}
  \item X
 \end{itemize}
...
%  \end{itemize}
 ...
 Data scientists and researchers at the \textbf{University of Wisconsin--Madison Data Science Institute} are using this workflow pattern for work across:
 \begin{itemize}
